...
The generated report is published to Telegraph with source images and the link is saved as `data/digests/daily-news-latest.url`. Bot buttons resend this link while it is younger than 24 hours; they do not trigger a new source fetch or LLM generation.
