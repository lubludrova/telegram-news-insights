...
The bot buttons `Telegram fetch` and `Reddit fetch` resend the latest generated daily report file. They do not collect sources or call the LLM. The latest report is valid for 24 hours and is regenerated by the daily scheduled run.
